    ...
    public partial class FormFilePicker : Form
    {
        ...
        private void FormFilePicker_Load(object sender, EventArgs e)
        {
            ...
            foreach (string dir in dirs)
            {
                ...
                if (File.Exists(filename))
                {
                    using (StreamReader reader = new StreamReader(filename))
                    {
                        try
                        {
                            ...
                            {
                                MessageBox.Show(fieldDirectory + " is beschadigd, Verwijder dit perceel", gStr.gsFileError,
                ...
                if (File.Exists(filename))
                {
                    ...
                    if (area == 0) fileList.Add("Geen kopakker");
                ...
                {
                    fileList.Add("Error");
                    MessageBox.Show(fieldDirectory + " is beschadigd, Verwijder dit perceel " +
        ...
        private void btnByDistance_Click(object sender, EventArgs e)
        {
            ...
            if (lvLines.Items.Count > 0)
            {
                ...
                {
                    this.chName.Text = "Afstand";
                    this.chName.Width = 140;

                    this.chDistance.Text = "Perceel naam";
            ...
            foreach (string dir in dirs)
            {
                ...
                if (File.Exists(filename))
                {
                    ...
                    if (File.Exists(filename))
                    {
                        ...
                        if (area == 0) fileList.Add("Geen koppakker");
                        else fileList.Add(Math.Round(area, 1).ToString().PadLeft(10));
                    }
