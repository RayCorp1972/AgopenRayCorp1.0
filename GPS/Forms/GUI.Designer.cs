    ...
    public partial class FormGPS
    {
        ...
        private void tmrWatchdog_tick(object sender, EventArgs e)
        {
            ...
            if (displayUpdateThreeSecondCounter != threeSeconds)
            {
                ...
                string toolSetings = (tool.toolWidth * m2FtOrM).ToString("N2") + unitsFtM;
                lblTopData.Text = ("Voertuig: "+ vehicleFileName + " - " + "Werkbreedte: " +  toolSetings);
                ...
                if (isJobStarted)
                {
                    ...
                    {
                        lblCurveLineName.Text = "AB-" + curve.curveArr[curve.numCurveLineSelected - 1].Name;
                    }
